...
// Convert the JSON string into a List of menu objects
  ...
  void requestPermissions() async {
    ...
    if (EnvConfig.isCalendar) await Permission.calendarFullAccess.request();
  ...
  Future<void> _checkInternetConnection() async {
    ...
    // Fix: Handle List<ConnectivityResult> properly
    final isOnline =
  ...
  Widget _buildMenuIcon(Map<String, dynamic> item, bool isActive,
      Color activeColor, Color defaultColor) {
