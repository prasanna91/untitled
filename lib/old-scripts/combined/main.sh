...
if [ -f "lib/scripts/utils/load_admin_config.sh" ]; then
    chmod +x lib/scripts/utils/load_admin_config.sh
    source lib/scripts/utils/load_admin_config.sh
    load_admin_config
...
if [ -f "lib/scripts/utils/configure_oauth.sh" ]; then
    chmod +x lib/scripts/utils/configure_oauth.sh
    source lib/scripts/utils/configure_oauth.sh
...
# Environment configuration already generated above
